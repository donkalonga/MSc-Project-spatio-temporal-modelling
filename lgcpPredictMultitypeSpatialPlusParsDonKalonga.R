function (formulaList, sd, typemark = NULL, Zmat = NULL, model.priorsList, 
          ...
          gradtrunc = Inf, ext = 2, inclusion = "touching") 
{
  ...
  class(lg) <- c("lgcpPredictMultitypeSpatialPlusParameters", "lgcpPredictMultitypeSpatialPlusParsDonKalonga",
