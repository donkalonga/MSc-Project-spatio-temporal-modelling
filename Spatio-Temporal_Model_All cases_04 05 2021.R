...
dat<-read.csv("ST_All-Lineages_Data.csv") %>% # 310 cases
...
SpatioTemporal_Model_All_Cases <- lgcpPredictSpatioTemporalPlusPars(formula = FORM_2, xyt = xyt, T = ti, laglength = LAGLENGTH, ZmatList = ZmatList, model.priors = priors, 
                             ...
                             mcmc.control = mcmcpars(mala.length = 10000, burnin = 1000, retain = 100, adaptivescheme = andrieuthomsh(inith = 1, alpha = 0.5, C = 1, 
